...
}},{title:"Employee",classNames:"name",key:"displayName",formatter:function(value){if(value.indexOf("ADHOCNOFILL")>=0){return"<span class='row-adhoc'>Shifts Not filled</span>"
...
},click:function(evt){var target=evt.target;if(target.className.indexOf("approve")>=0){var storeKey=parseInt(target.getAttribute("storeKey"),10);
