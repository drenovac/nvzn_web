Nvzn=SC.Application.create({NAMESPACE:"Nvzn",VERSION:"201302041715-22-g92b358b-101",isDemo:YES,canEditManager:NO,canApproveManager:NO,canApproveManagerDidChange:function(){if(!this.get("canApproveManager")){this.set("canEditManager",NO)
...
}var ret="",classes="timecard-cell ",allClasses,status,approveClass="approve",cid,approveClasses,sent=Nvzn.local.getPath("sent");
...
if(item.get("type")!=="N"&&item.get("desc")!==null){ret+="<span class='tc_desc'>"+item.get("desc")+"</span></br>"
