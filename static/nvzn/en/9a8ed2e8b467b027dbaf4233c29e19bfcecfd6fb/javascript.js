Nvzn=SC.Application.create({NAMESPACE:"Nvzn",VERSION:"201302041715-18-g1ee8b1c-97",isDemo:YES,canEditManager:NO,canApproveManager:NO,canApproveManagerDidChange:function(){if(!this.get("canApproveManager")){this.set("canEditManager",NO)
