Nvzn=SC.Application.create({NAMESPACE:"Nvzn",VERSION:"201302041715-25-g66bbb16-104",isDemo:YES,canEditManager:NO,canApproveManager:NO,canApproveManagerDidChange:function(){if(!this.get("canApproveManager")){this.set("canEditManager",NO)
